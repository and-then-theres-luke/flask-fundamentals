...
@app.route('/play')
def index():
    return render_template('index.html', num_boxes=5, bg_color = "blue")

@app.route('/play/<int:num>')
def index2(num):
    return render_template('index.html', num_boxes=num, bg_color = "blue" )

@app.route('/play/<int:num>/<string:bg>')
def index3(num, bg):
    return render_template('index.html', num_boxes=num, bg_color = bg )
